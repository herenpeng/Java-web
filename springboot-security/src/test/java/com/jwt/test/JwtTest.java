...
public class JwtTest {
    ...
    public static void main(String[] args) throws JsonProcessingException, InvalidKeyException, BadPaddingException, ShortBufferException, IllegalBlockSizeException, NoSuchPaddingException, NoSuchAlgorithmException {
        Map map = new HashMap<>();
        map.put("username", "张三");
        map.put("role", "admin");
