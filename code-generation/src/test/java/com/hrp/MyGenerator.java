...
public class MyGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setAuthor("herenpeng");
        gc.setOpen(false);
        mpg.setGlobalConfig(gc);

        // 数据源配置
        DataSourceConfig dsc = new DataSourceConfig();
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/zero-admin?characterEncoding=utf8&useSSL=false&serverTimezone=Asia/Shanghai");
        ...
        pc.setParent("com.hrp");//你哪个父目录下创建包
